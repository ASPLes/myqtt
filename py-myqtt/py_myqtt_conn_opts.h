...
#ifndef __PY_MYQTT_CONN_OPTS_H__
#define __PY_MYQTT_CONN_OPTS_H__

/* include base header */
#include <py_myqtt.h>

typedef struct _PyMyQttConnOpts PyMyQttConnOpts;

/** 
 * @brief Public macro that allows to perform a casting to the
 * PyMyQttConnOpts type.
 */
#define PY_MYQTT_CONN_OPTS(f) ((PyMyQttConnOpts *)f)

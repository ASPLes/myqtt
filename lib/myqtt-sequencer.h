 ...
 */
#ifndef __MYQTT_SEQUENCER_H__
#define __MYQTT_SEQUENCER_H__
...
axl_bool myqtt_sequencer_direct_send              (MyQttConn       * conn,
						   MyQttWriterData * packet);

void     myqtt_sequencer_signal_update            (MyQttConn    * conn);

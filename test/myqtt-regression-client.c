...
axl_bool test_17c_common (const char * label, const char * topic, const char * msg_content, MyQttQos qos, axl_bool retain_flag) {
	...
	printf ("Test %s: checking big message (checking with message size: %d, qos: %d)..\n", label, (int) strlen (msg_content), qos);
	...
	/* subscribe to a topic without retained message */
	if (! myqtt_conn_sub (conn, 10, topic, qos, &sub_result)) {
		printf ("ERROR: unable to subscribe, myqtt_conn_sub () failed, sub_result=%d\n", sub_result);
		return axl_false;
	} /* end if */
	...
	/* get message (ensure we don't receive anything) */
	printf ("Test %s: getting reply (3 seconds)..\n", label);
	msg   = myqtt_async_queue_timedpop (queue, 3000000);
	if (msg == NULL) {
		printf ("ERROR: expected message but NULL was received..\n");
		return axl_false;
	} /* end if */

	printf ("Test %s: received message size %d\n", label, (int) strlen (msg_content));
	if (myqtt_msg_get_app_msg_size (msg) != strlen (msg_content)) {
		printf ("ERROR: Test --: expected to receive message with size %d but received %d\n", 
			(int) strlen (msg_content), myqtt_msg_get_app_msg_size (msg));
		return axl_false;
	}

	if (! axl_cmp (myqtt_msg_get_app_msg (msg), msg_content)) {
		printf ("ERROR: Test --: expected to receive different message content..\n");
		return axl_false;
	} /* end if */

	/* check qos of the message received */
	if (myqtt_msg_get_qos (msg) != qos) {
		printf ("ERROR: Test --: expected qos=%d but received=%d\n", qos, myqtt_msg_get_qos (msg));
		return axl_false;
	} /* end if */
...
axl_bool test_17c_with_qos (MyQttQos qos, axl_bool retain_flag) {
	char * really_big;
	int    size;

	if (! test_17c_common ("17-c", "this/is/a/test", define_big_mesg, qos, retain_flag))
		return axl_false;

	if (! test_17c_common ("17-c1", "this/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topic", define_big_mesg, qos, retain_flag))
		return axl_false;

	if (! test_17c_common ("17-c2", "this/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topic", define_big_mesg, qos, retain_flag))
		return axl_false;

	if (! test_17c_common ("17-c3", "this/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topic", define_big_mesg, qos, retain_flag))
		return axl_false;

	if (! test_17c_common ("17-c4", "this/is/a/test", define_big_mesg_2, qos, retain_flag))
		return axl_false;

	if (! test_17c_common ("17-c5", "this/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topic", define_big_mesg_2, qos, retain_flag))
		return axl_false;

	if (! test_17c_common ("17-c6", "this/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topic", define_big_mesg_2, qos, retain_flag))
		return axl_false;
	...
	if (! test_17c_common ("17-c7", "this/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topicthis/is/a/test/this-is-a-very-long-topic", really_big, qos, retain_flag))
		return axl_false;
...
axl_bool test_17c (void) {
	...
	printf ("Test 17-c: testing with retain flag=1\n");
	if (! test_17c_with_qos (MYQTT_QOS_0, axl_true))
		return axl_false;
	if (! test_17c_with_qos (MYQTT_QOS_1, axl_true))
		return axl_false;
	if (! test_17c_with_qos (MYQTT_QOS_2, axl_true))
		return axl_false;

	printf ("Test 17-c: testing with retain flag=0\n");
	if (! test_17c_with_qos (MYQTT_QOS_0, axl_false))
		return axl_false;
	if (! test_17c_with_qos (MYQTT_QOS_1, axl_false))
		return axl_false;
	if (! test_17c_with_qos (MYQTT_QOS_2, axl_false))
		return axl_false;
